...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <script type="text/javascript">
					...
					<s:iterator value="#session.map">
                      ...
                      <!-- 购物列表开始 -->
						<tr class='td_no_bord'>
							...
							<td>
								<a target="_blank" href="<s:url action='ProductAll'/>?id=<s:property value="value.product.id"/>">
								<s:property value="value.product.name"/></a>
							</td>
							<td class="buy_td_5">
								<span class="c_gray"><s:property value="value.product.pricing"/></span>
							</td>
							<td class="buy_td_4">
								&nbsp;&nbsp;
								<span>￥<s:property value="value.product.sellingPrice"/></span>
							</td>
							<td class="buy_td_1">
							...
							<td >
								<input  class="del_num" type="text" size="3" maxlength="4" value="<s:property value='value.count'/>"/>
								<a href="#" onclick="location='<s:url action='cartChange'/>?productId=<s:property value='key'/>&count='+$(this).prev().val() ">变更</a>
							</td>
							<td>
								<a href="<s:url action='delete'/>?productId=<s:property value='value.product.id'/>">删除</a>
							</td>
						</tr>
				...
				<div class="choice_balance">
					...
					<div class="total_balance">
						<div class="save_total">
							您共节省：
							<span class="c_red"> ￥<span id="total_economy"><s:property value="#session.savePrice"/></span>
							</span>
							...
							<span class="c_red_b"> ￥<span id='total_account'><s:property value="#session.price"/></span>
							</span>
						</div>
	...
	<s:if test="#session.map2!=null&&#session.map2.size()!=0">
				...
				<tbody>
					...
					<tr>
						...
						<td width="106" class=buy_td_5>
							￥<s:property value="value.product.pricing"/>
						</td>
						<td width="134" class=buy_td_4>
							<span>￥<s:property value="value.product.sellingPrice"/></span>
						</td>
						<td width="56" class=buy_td_1>
							<a href="<s:url action='Recover'/>?productId=<s:property value='key'/>">恢复</a>
						</td>
