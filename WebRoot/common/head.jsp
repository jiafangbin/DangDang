    	...
    	<div class="head_welcome">
	    	<div class="head_welcome_right">
			 ...
			 <span class="head_welcome_text"> <span class="little_n">
					| <a href="${pageContext.request.contextPath }/main/main.jsp" name="mydangdang" class="head_black12a">我的当当</a> | <a
					href="#" name="helpcenter" class="head_black12a" target="_blank">帮助</a>
					| </span> </span>
			 <div class="cart gray4012">
				<a href="<s:url value='/cart/cart_list.jsp'/>" ><font style="color:red">购物车</font></a>
			 </div>
		 </div>
		 <span class="head_toutext" id="logininfo">
		<s:if test="#session.user!=null">
		<b>您好:<font style="color:orange"><s:property value="#session.user.username"/></font>，欢迎光临当当网</b>
		[&nbsp;<a href="<s:url action='Exit'/>" class="b">登出</a>&nbsp;]
		</s:if>
		<s:else>
