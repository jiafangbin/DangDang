...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
      ...
      </style><link href="${pageContext.request.contextPath }/css/page_bottom.css" rel="stylesheet" type="text/css" />
			...
			<div class="enter_in">
				...
				<div class="center">
					...
					<div class="main">
						...
						<form method="post" action="<s:url value="/user/user_UserLogin"/>" id="ctl00">
							<ul>
								<li>
